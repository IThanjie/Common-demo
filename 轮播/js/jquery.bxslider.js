    ...
    b.fn.bxSlider = function(s) {
        ...
        var B = function(T, S, U, W) {
            if (j.usingCSS) {
                ...
                if (S == "slide") {
                    H.css(j.animProp, V);
                    H.bind("transitionend webkitTransitionEnd oTransitionEnd MSTransitionEnd",
                    function() {
                ...
                R[j.animProp] = T;
                if (S == "slide") {
                    H.animate(R, U, j.settings.easing,
                    function() {
                        p()
                    })
                } else {
